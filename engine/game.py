...
class Game:
    ...
    def __init__(self):
        ...
        self.button2 = button.Button("menu/mainoption2.xml", "Prueba2", 400, 360, 'cheesebu', True)
        self.button3 = button.Button("menu/mainoption1.xml", "Prueba2", 400, 400, 'cheesebu', True)
